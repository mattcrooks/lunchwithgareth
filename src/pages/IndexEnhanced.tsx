          ...
          <CardContent className="p-6 text-center">
            {completionResult.success ? (
              <>
                ...
                <h3 className="font-semibold mb-2">Payment Request Published</h3>
                <p className="text-sm text-muted-foreground mb-4">
                  Your bill split request has been published to Nostr and stored locally.
                </p>
                {completionResult.eventId && (
                  <div className="bg-muted p-3 rounded-lg mb-4">
                    <p className="text-xs text-muted-foreground">Event ID:</p>
                    <p className="font-mono text-sm break-all">{completionResult.eventId}</p>
                  </div>
                )}
              </>
            ) : (
              <>
                ...
                {completionResult.receiptId && (
                  <Alert className="mb-4">
                    <AlertDescription>
                      The request has been saved locally and can be retried later.
                    </AlertDescription>
                  </Alert>
                )}
              </>
